...
- Детекція лиця
- Маніпуляція спотворення зображення заради добавлення шуму та складного освітлення
...
- **Детекція лиця**![img1.png](screenshots/img1.png)
- **Детекція на кількох зображеннях**![img2.png](screenshots/img2.png)
